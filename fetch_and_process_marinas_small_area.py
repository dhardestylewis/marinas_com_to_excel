...
# Define a smaller bounding box for a portion of the East Coast (e.g., New Jersey)
north, south, east, west = 41.357423, 38.928519, -73.902454, -75.563587
...
df.to_excel('us_marinas_data_small_area.xlsx', index=False)

print("Data has been saved to us_marinas_data_small_area.xlsx")
